...
INSTRUCTIONS:
1. Create exactly ${dayCount} training days. Each day MUST have a compelling, catchy "label" (e.g., "Full Body Burn", "Core Power") and a highly personalized 2-sentence "coachNote" addressing the user. The coachNote MUST be incredibly warm, reassuring, and friendly. Instead of intense "no pain no gain" language, paint a positive and encouraging picture of how great and refreshed they will feel after finishing it (e.g. "Take your time with this session. By the end, your muscles will feel nicely warmed up and you'll have done something wonderful for your body today!"). Use extremely plain, conversational, beginner-friendly language for BOTH the label and the coachNote. Avoid complex fitness jargon like "hypertrophy", "protein synthesis", "metabolic", etc. Speak like a gentle, encouraging friend.
