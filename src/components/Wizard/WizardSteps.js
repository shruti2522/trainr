...
export const WEEKLY_TIME_OPTIONS = [
  { key: 'under_2h', label: 'Under 2 days / week', desc: 'Minimal time  high-efficiency workouts only' },
  { key: '2_4h',     label: '2 – 4 days / week',   desc: 'Moderate commitment, consistent progress' },
  { key: '4_6h',     label: '4 – 6 days / week',   desc: 'Solid training volume for clear results' },
  { key: '6_plus',   label: '6 + days / week',     desc: 'High commitment, serious performance gains' },
];
  ...
  return (
    <div className="wizard-step animate-fade-up">
      <div className="wizard-step-header">
        <h2 className="wizard-step-title">How long do you want to commit everyday??</h2>
...
export function StepWeeklyTime({ value, onChange }) {
  return (
    <div className="wizard-step animate-fade-up">
      <div className="wizard-step-header">
        <h2 className="wizard-step-title">How many days can you dedicate each week?</h2>
        <p className="wizard-step-subtitle">
